...
public static class IO
{
    ...
    /// </summary>
    /// <returns>
    /// The selected folder path if confirmed; otherwise <c>null</c>.
    /// </returns>
    ...
    /// <returns>
    /// The selected file path if confirmed; otherwise <c>null</c>.
    /// </returns>
    ...
    /// <returns>
    /// The file path specified by the user if confirmed; otherwise <c>null</c>.
    /// </returns>
